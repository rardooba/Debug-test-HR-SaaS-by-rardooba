...
export default class {
  ...
  handleShowTickets(e, bills, index) {
    ...
    //! #status-bills-container${index} #open-bill${bill.id} évite l'ajout répétitif d'event sur la note de frais. au click sur la flèche (open cat) la f(x) return un array vide ce qui supprime les listener sur les items de la cat.
    bills.forEach(bill => {
